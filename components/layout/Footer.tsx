        ...
        <footer className="border-t border-border/40 bg-zinc-50/50 dark:bg-zinc-900/20">
            <div className="container max-w-5xl mx-auto py-16 px-4 md:px-6">
                <div className="grid gap-12 md:grid-cols-5">
                    ...
                    {/* Calculators */}
                    <div>
                        <h3 className="font-medium mb-4 tracking-tight text-foreground">Calculators</h3>
                    ...
                    {/* States */}
                    <div>
                        <h3 className="font-medium mb-4 tracking-tight text-foreground">States</h3>
                        <ul className="space-y-3">
                    ...
                    <div className="space-y-8">
                        <div>
                            <h3 className="font-medium mb-4 tracking-tight text-foreground">Company</h3>
                            <ul className="space-y-3">
                        ...
                        <div>
                            <h3 className="font-medium mb-4 tracking-tight text-foreground">Legal</h3>
                            <ul className="space-y-3">
                ...
                <div className="mt-16 pt-8 border-t border-border/40 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-muted-foreground/60">
                    <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4">
                        ...
                        <p>Tax rules last reviewed: December 2026</p>
                    </div>
                    <p className="text-muted-foreground/50">
                        Developed by{' '}
                        <a
                            href="https://rishav.online"
                            target="_blank"
