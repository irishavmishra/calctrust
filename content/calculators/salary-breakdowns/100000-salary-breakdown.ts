...
const content: BlogContent = {
  ...
  "sections": {
    ...
    "examples": [
      "Houston, TX (No State Tax) - Gross: $100,000 - Federal tax: ~$13,000 - FICA: $7,650 - Net: ~$79,350 (~$6,612/month)**",
      "San Francisco, CA - Gross: $100,000 - Federal tax: ~$13,000 - California tax: ~$5,200 - SDI: ~$1,100 - FICA: $7,650 - Net: ~$73,050 (~$6,087/month)** - Plus $3,000+/month rent = 50%+ to housing",
      "With Max 401(k)** - 401(k): $23,500 (2025 limit) - Taxable income reduced to $76,500 - Federal tax reduced by ~$5,000 - Net cash lower but building wealth"
    ],
    "faq": [
      {
        "question": "How much is $100K per hour?",
        "answer": "$100,000 ÷ 2,080 = $48.08 per hour."
      },
      {
        "question": "What is $100K biweekly after taxes?",
        "answer": "Approximately $2,650-3,000 biweekly depending on state."
      },
      {
      ...
      },
      {
        ...
        "answer": "Target 20%+ ($20,000/year) including retirement contributions."
      }
    ],
    "relatedCalculators": [
      {
      ...
      },
      {
        ...
        "href": "/usa/90000-salary-breakdown"
      },
      {
        "title": "$110,000 Salary Breakdown",
        "href": "/usa/110000-salary-breakdown"
      },
      {
        "title": "$120,000 Salary Breakdown",
        "href": "/usa/120000-salary-breakdown"
      }
    ],
