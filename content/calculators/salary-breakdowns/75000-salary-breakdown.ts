...
const content: BlogContent = {
  ...
  "sections": {
    ...
    "examples": [
      ...
      "California (High Tax) - Net annual: ~$57,000 - Monthly take-home: ~$4,750 - $375/month less than Texas**",
      "With 10% 401(k)** - 401(k) contribution: $7,500/year - Reduces federal tax by ~$1,650 - Net cash: ~$55,000 + $7,500 invested"
    ],
    "faq": [
      {
        "question": "How much is $75,000 per hour?",
        "answer": "$75,000 ÷ 2,080 hours = $36.06 per hour."
      },
      {
        "question": "What is $75,000 biweekly after taxes?",
        "answer": "Approximately $2,150-2,400 depending on state, with no-tax states at the high end."
      },
      {
        "question": "Is $75K middle class?",
        "answer": "Yes. $75,000 is solidly middle class in most of America, comfortable in affordable areas."
      },
      {
        "question": "How much house can I afford on $75K?",
        "answer": "Using the 3x salary rule: ~$225,000 home. With 28% DTI rule: ~$1,750/month housing payment."
      }
    ],
    "relatedCalculators": [
      {
      ...
      },
      {
        ...
        "href": "/usa/70000-salary-breakdown"
      },
      {
        "title": "$80,000 Salary Breakdown",
        "href": "/usa/80000-salary-breakdown"
      },
      {
