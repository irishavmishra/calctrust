...
const content: BlogContent = {
  ...
  sections: {
    ...
    faq: [{ question: 'How much is $2,800 biweekly annually?', answer: '$72,800/year.' }],
    relatedCalculators: [{ title: '$2,500 Biweekly', href: '/usa/2500-biweekly-to-annual' }, { title: '$3,000 Biweekly', href: '/usa/3000-biweekly-to-annual' }],
