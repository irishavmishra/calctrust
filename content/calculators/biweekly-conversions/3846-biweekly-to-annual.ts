...
const content: BlogContent = {
  ...
  metaTitle: '$3,846 Biweekly to Annual Salary | 2025 Calculator',
  metaDescription: 'Convert $3,846 biweekly pay to annual salary. This calculator estimates yearly income based on standard 26 pay period assumptions.',
  sections: {
