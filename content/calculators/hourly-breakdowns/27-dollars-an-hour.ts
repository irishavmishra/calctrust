...
const content: BlogContent = {
  ...
  metaTitle: '$27/Hour is How Much a Year? | 2025 Calculator',
  metaDescription: 'Convert $27 hourly wage to annual salary. This calculator estimates yearly, monthly, and weekly income based on standard 40-hour work weeks.',
  sections: {
    whatThisHelps: [
