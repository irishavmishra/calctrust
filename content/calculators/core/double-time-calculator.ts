...
const content: BlogContent = {
  ...
  "sections": {
    ...
    "howItWorks": [],
    "deepDive": [
      "Here's an important clarification: federal law does not require double-time pay. The Fair Labor Standards Act (FLSA) only mandates time and a half (1.5x) for overtime hours beyond 40 per week. Double time exists through:",
      "- State laws (California, primarily) - Union collective bargaining agreements - Employer policies - Industry practice",
      "This means most American workers aren't guaranteed double time by law, but many receive it through contractual or policy-based arrangements.",
      "California has the nation's most comprehensive double-time requirements:",
      "Daily Overtime Structure: - Hours 1-8: Regular rate - Hours 9-12: Time and a half (1.5x) - Hours 13+: Double time (2x)",
      "Seventh Consecutive Workday: - Hours 1-8 on day 7: Time and a half (1.5x) - Hours 9+ on day 7: Double time (2x)",
      ...
      "Utilities: Storm response and emergency repairs often pay double time",
      "Transportation: Railroad and airline workers may have contractual double-time provisions",
      "Entertainment: Film and television production overtime often escalates to double time",
      "Manufacturing: Some plants pay double time for Sunday work or mandatory extra shifts",
      "Double time significantly accelerates earnings for affected hours:",
      "Comparison on $24/hour base rate: - Regular hour: $24 - Time and a half hour: $36 (+50%) - Double time hour: $48 (+100%)",
      "Weekly impact example (50-hour week, CA rules): - 40 regular hours: $960 - 8 time-and-a-half hours: $288 - 2 double-time hours (hours 13-14 on a long day): $96 - Total: $1,344 vs. $1,200 for straight 50 hours"
    ],
    "examples": [
      "California 14-Hour Shift - Regular rate: $26.00 - Hours 1-8: $26 × 8 = $208 (regular) - Hours 9-12: $39 × 4 = $156 (1.5x) - Hours 13-14: $52 × 2 = $104 (2x) - Total: $468** (effective rate: $33.43/hour)",
      "Seventh Consecutive Workday (California) - Regular rate: $22.00 - Days 1-6: 40 total hours at regular rate = $880 - Day 7: 10-hour shift   - Hours 1-8: $33 × 8 = $264 (1.5x)   - Hours 9-10: $44 × 2 = $88 (2x) - Week total: $1,232** for 50 hours",
      "Holiday Double Time (Employer Policy) - Regular rate: $28.00 - Christmas Day shift: 8 hours at double time - Double-time pay: $56 × 8 = $448 - One shift earnings: $448** (vs. $224 regular day)",
    ...
    "assumptions": [
      "Standard 2x multiplier: Applies double time at exactly twice your regular hourly rate",
      "Input-based hours: Uses the overtime hours you specify without determining qualification automatically",
      "Gross pay only: Shows pre-tax earnings before deductions",
      "Single rate structure: Doesn't automatically calculate mixed 1.5x and 2x scenarios",
      "Non-exempt status: Assumes you're eligible for overtime premiums",
      "Employer-neutral: Doesn't account for specific employer policies on double-time qualification",
    ...
    "whyResultsVary": [
      "State law variations: California requires double time in specific circumstances; most states don't",
      "Union contract specifics: Collective bargaining agreements define exactly when double time applies",
      "Employer policy discretion: Private policies may provide double time in situations not legally required",
      "Bonus integration: California requires non-discretionary bonuses factor into regular rate for overtime calculations",
      "Industry practices: Some sectors have customary double-time provisions that may or may not be contractual",
      "Workweek definition: Your employer's chosen 7-day period affects consecutive day calculations"
    ],
    "faq": [
      {
        "question": "What is double time pay?",
        "answer": "Double time means earning twice (2x) your regular hourly rate. If you make $20/hour normally, double time is $40/hour."
      },
      {
        "question": "Is double time required by law?",
        "answer": "Not federally. California requires double time for hours over 12 per day and certain seventh-day work. Most other situations depend on employer policy or union contracts."
      },
      {
        "question": "When does double time apply in California?",
        "answer": "After 12 hours in a workday and after 8 hours on your seventh consecutive workday for the same employer."
      },
      {
        "question": "Do I get double time on holidays?",
        "answer": "Federal law doesn't require holiday premium pay. Many employers offer double time on major holidays as a policy, but it's not legally mandated."
      },
      {
        "question": "How is double time different from time and a half?",
        "answer": "Time and a half = 1.5x regular rate. Double time = 2x regular rate. Double time is a 33% greater premium than time and a half."
      },
      {
        "question": "Can I negotiate for double time in my contract?",
        "answer": "Yes. Individual employment contracts and collective bargaining agreements can include double-time provisions regardless of legal requirements."
      }
    ],
    "relatedCalculators": [
      {
        "title": "Time and a Half Calculator",
        "href": "/usa/time-and-a-half-calculator"
      },
      {
