...
const content: BlogContent = {
  "slug": "75000-salary-massachusetts",
  "category": "state-salary",
  "title": "$75,000 Salary in Massachusetts",
  "subheading": "Calculate your take-home pay on a $75,000 salary in Massachusetts. See federal and state tax withholdings, FICA deductions, and monthly breakdowns.",
  "sections": {
    "whatThisHelps": [
      "Understand your take-home pay on a $75,000 salary in Massachusetts",
    ...
    "faq": [
      {
        "question": "What is the take-home pay for $75,000 in Massachusetts?",
      ...
      },
      {
        ...
        "answer": "Yes, Massachusetts has state income tax that will be deducted from your $75,000 salary along with federal taxes."
      },
      {
        "question": "How much is $75,000 per month after taxes in Massachusetts?",
