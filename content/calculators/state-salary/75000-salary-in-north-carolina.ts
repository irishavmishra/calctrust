...
const content: BlogContent = {
  slug: '75000-salary-in-north-carolina',
  ...
  metaTitle: '$75K Salary in North Carolina | Take-Home Pay 2025',
  metaDescription: 'Calculate take-home pay for a $75K salary in North Carolina. Estimates net income after federal and state taxes. Actual results may vary.',
  sections: {
    ...
    relatedCalculators: [{ title: '$100K North Carolina', href: '/usa/100000-salary-in-north-carolina' }],
