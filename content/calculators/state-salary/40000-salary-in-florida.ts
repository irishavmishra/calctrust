...
const content: BlogContent = {
  ...
  sections: {
    ...
    relatedCalculators: [{ title: '$50K Florida', href: '/usa/50000-salary-in-florida' }, { title: 'Take Home Pay Calculator', href: '/usa/take-home-pay-calculator' }],
