...
const content: BlogContent = {
  "slug": "120000-salary-texas",
  "category": "state-salary",
  "title": "$120,000 Salary in Texas",
  "subheading": "Calculate your take-home pay on a $120,000 salary in Texas. See federal and state tax withholdings, FICA deductions, and monthly breakdowns.",
  "sections": {
    "whatThisHelps": [
      "Understand your take-home pay on a $120,000 salary in Texas",
    ...
    "faq": [
      {
        "question": "What is the take-home pay for $120,000 in Texas?",
      ...
      },
      {
        ...
        "answer": "No, Texas does not have a state income tax on wages, which means more of your $120,000 salary goes to take-home pay."
      },
      {
        "question": "How much is $120,000 per month after taxes in Texas?",
