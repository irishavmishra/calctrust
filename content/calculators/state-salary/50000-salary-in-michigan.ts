...
const content: BlogContent = {
  ...
  metaTitle: '$50K Salary in Michigan | Take-Home Pay 2025',
  metaDescription: 'Calculate take-home pay for a $50K salary in Michigan. Estimates net income after federal and state taxes. Actual results may vary.',
  sections: {
