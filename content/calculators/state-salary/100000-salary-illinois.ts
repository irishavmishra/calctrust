...
const content: BlogContent = {
  "slug": "100000-salary-illinois",
  "category": "state-salary",
  "title": "$100,000 Salary in Illinois",
  "subheading": "Calculate your take-home pay on a $100,000 salary in Illinois. See federal and state tax withholdings, FICA deductions, and monthly breakdowns.",
  "sections": {
    "whatThisHelps": [
      "Understand your take-home pay on a $100,000 salary in Illinois",
      "Calculate federal and Illinois state tax withholdings",
    ...
    "whoUsefulFor": [
      "Job seekers evaluating offers in Illinois",
      "Current Illinois residents planning their finances",
      "People considering relocating to Illinois",
      "HR professionals explaining compensation to Illinois employees",
      "Financial planners helping clients in Illinois"
    ],
    "howItWorks": [
      ...
      "Illinois state tax rates are automatically calculated",
      "FICA taxes (Social Security and Medicare) are deducted",
      "Your net take-home pay is displayed across all pay periods"
    ],
    "assumptions": [
      "Uses 2025 federal tax brackets and Illinois state tax rates",
    ...
    "commonMistakes": [
      "Forgetting that Illinois may have local/city taxes in addition to state tax",
    ...
    "faq": [
      {
        "question": "What is the take-home pay for $100,000 in Illinois?",
        "answer": "Your take-home pay depends on your filing status and deductions. Use the calculator above to get an accurate estimate based on current Illinois and federal tax rates."
      },
      {
        "question": "Does Illinois have state income tax?",
        "answer": "Yes, Illinois has state income tax that will be deducted from your $100,000 salary along with federal taxes."
      },
      {
        "question": "How much is $100,000 per month after taxes in Illinois?",
