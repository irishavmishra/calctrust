...
const content: BlogContent = {
  slug: '75000-salary-in-new-jersey',
  ...
  metaTitle: '$75K Salary in New Jersey | Take-Home Pay 2025',
  metaDescription: 'Calculate take-home pay for a $75K salary in New Jersey. Estimates net income after federal and state taxes. Actual results may vary.',
  sections: {
    ...
    relatedCalculators: [{ title: '$100K New Jersey', href: '/usa/100000-salary-in-new-jersey' }],
