...
const content: BlogContent = {
  ...
  sections: {
    ...
    relatedCalculators: [{ title: '$50K Texas', href: '/usa/50000-salary-texas' }, { title: 'Take Home Pay Calculator', href: '/usa/take-home-pay-calculator' }],
