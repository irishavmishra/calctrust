...
const content: BlogContent = {
  slug: '100000-salary-in-new-york',
  category: 'state-salary',
  title: '$100,000 Salary in New York',
  subheading: 'Calculate your take-home pay on a $100,000 salary in New York.',
  metaTitle: '$100K Salary in New York | Take-Home Pay 2025',
  metaDescription: 'Calculate take-home pay for a $100K salary in New York. Estimates net income after federal and state taxes. Actual results may vary.',
  sections: {
    whatThisHelps: ['Understand take-home pay on $100K in NY', 'Calculate NY state + NYC taxes'],
    whoUsefulFor: ['NY professionals', 'NYC tech/finance workers'],
