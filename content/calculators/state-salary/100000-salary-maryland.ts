...
const content: BlogContent = {
  ...
  "subheading": "Calculate your take-home pay on a $100,000 salary in Maryland. See federal and state tax withholdings, FICA deductions, and monthly breakdowns.",
  "sections": {
    "whatThisHelps": [
      "Understand your take-home pay on a $100,000 salary in Maryland",
    ...
    "faq": [
      {
        "question": "What is the take-home pay for $100,000 in Maryland?",
      ...
      },
      {
        ...
        "answer": "Yes, Maryland has state income tax that will be deducted from your $100,000 salary along with federal taxes."
      },
      {
        "question": "How much is $100,000 per month after taxes in Maryland?",
