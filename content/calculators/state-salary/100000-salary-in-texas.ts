...
const content: BlogContent = {
  ...
  sections: {
    ...
    faq: [{ question: 'What is $100K take-home in TX?', answer: '~$6,500-6,800/month.' }],
    relatedCalculators: [{ title: '$120K Texas', href: '/usa/120000-salary-in-texas' }],
