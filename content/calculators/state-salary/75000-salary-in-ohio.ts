...
const content: BlogContent = {
  ...
  metaTitle: '$75K Salary in Ohio | Take-Home Pay 2025',
  metaDescription: 'Calculate take-home pay for a $75K salary in Ohio. Estimates net income after federal and state taxes. Actual results may vary.',
  sections: {
