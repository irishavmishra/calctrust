...
const content: BlogContent = {
  ...
  metaTitle: '$75K Salary in Texas | Take-Home Pay 2025',
  metaDescription: 'Calculate take-home pay for a $75K salary in Texas. Estimates net income after federal and state taxes. Actual results may vary.',
  sections: {
    ...
    relatedCalculators: [{ title: '$100K Texas', href: '/usa/100000-salary-in-texas' }],
