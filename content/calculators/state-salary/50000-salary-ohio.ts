...
const content: BlogContent = {
  "slug": "50000-salary-ohio",
  "category": "state-salary",
  "title": "$50,000 Salary in Ohio",
  "subheading": "Calculate your take-home pay on a $50,000 salary in Ohio. See federal and state tax withholdings, FICA deductions, and monthly breakdowns.",
  "sections": {
    "whatThisHelps": [
      "Understand your take-home pay on a $50,000 salary in Ohio",
    ...
    "faq": [
      {
        "question": "What is the take-home pay for $50,000 in Ohio?",
      ...
      },
      {
        ...
        "answer": "Yes, Ohio has state income tax that will be deducted from your $50,000 salary along with federal taxes."
      },
      {
        "question": "How much is $50,000 per month after taxes in Ohio?",
