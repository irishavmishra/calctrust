/**
 * Calculator Content Engine
 * 
 * This file combines manual calculator entries with programmatically
 * generated pages. Types, data, and generators have been extracted
 * to separate modules for maintainability.
 * 
 * @see ./calculators/types.ts - Type definitions
 * @see ./calculators/data/ - State and value data
 * @see ./calculators/generators/ - Page generator functions
 */

// Import types from new module
import type { CalculatorPageData } from './calculators/types';
export type {
    CalculatorType,
    CalculatorCategory,
    FAQItem,
...
// Import form options for use in manual entries
import { filingStatusOptions, payFrequencyOptions } from './calculators/types';
export { filingStatusOptions, payFrequencyOptions };

// Import generators from new modules
import {
